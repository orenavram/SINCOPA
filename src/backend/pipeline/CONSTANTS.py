...
WEBSERVER_NAME = 'sincopa'
WEBSERVER_URL = f'https://{WEBSERVER_NAME}.tau.ac.il'
WEBSERVER_TITLE = '<b>Detecting selective sweeps in bacteria based on <i>Similarity of INCOngruent PAtterns</i></b>'
...
MAIN_SCRIPT = f'/bioseq/{WEBSERVER_NAME}/{WEBSERVER_NAME}.py'
REQUIRED_MODULES = ['gcc/gcc-6.2.0', 'python/python-3.6.7']
